...
public controller(){
	...
	*/
	...
	ImageIcon select = getScaledImage( new ImageIcon("Images/Button original.png"), hunter.getWidth(), hunter.getHeight());
	...
	change.setFont(new Font("Arial Black", Font.PLAIN, screen.getWidthy()/95));
...
public void onGameOver() {
	...
	GameOver over = new GameOver(winner);

	//view.setVisible(false);
	clip.stop();
	playsound("sounds/Victory.wav");
	updatedata();
	JOptionPane.showOptionDialog(view, over.getPanel(),"Game Over",JOptionPane.DEFAULT_OPTION,JOptionPane.PLAIN_MESSAGE, null, new Object[]{}, null);
	System.exit(0);
...
//	copy.setHorizontalTextPosition(JButton.CENTER);
	...
	for(Minion m1:h2.getField()){
		if(m1.getName().equals("Chromaggus")&&OppButtons.size()<10){
			OppButtons.add(copy);
